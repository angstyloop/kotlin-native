...
protected:
    ...
    private:
        friend class SingleLockListBase;
    ...
    // NOTE: Do not add any fields here, this is an interface. Also, it's destructor is non-virtual.
};
...
public:
    ...
    Node* Front() noexcept { return root_.get(); }

    Node* Back() noexcept { return last_; }
