...
TEST(SingleLockListTest, FrontAndBack) {
    IntList list;

    EXPECT_THAT(list.Front(), nullptr);
    EXPECT_THAT(list.Back(), nullptr);

    auto* firstNode = list.EmplaceBack(1);

    EXPECT_THAT(list.Front(), firstNode);
    EXPECT_THAT(list.Back(), firstNode);

    auto* secondNode = list.EmplaceBack(2);

    EXPECT_THAT(list.Front(), firstNode);
    EXPECT_THAT(list.Back(), secondNode);

    auto* thirdNode = list.EmplaceBack(3);

    EXPECT_THAT(list.Front(), firstNode);
    EXPECT_THAT(list.Back(), thirdNode);

    list.Erase(firstNode);

    EXPECT_THAT(list.Front(), secondNode);
    EXPECT_THAT(list.Back(), thirdNode);

    list.Erase(thirdNode);
